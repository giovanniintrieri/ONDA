...
export default function Home() {
 ...
 async function importFiles(files: File[], demo = false) {
  ...
  const title = view === 'downloads' ? 'Scarica musica.' : view === 'algorithm' ? 'Il tuo algoritmo.' : view === 'home' ? 'La tua musica, oggi.' : view === 'library' ? 'La tua libreria' : view === 'favorites' ? 'I tuoi preferiti' : automatic?.name || playlist?.name || 'La tua libreria';
